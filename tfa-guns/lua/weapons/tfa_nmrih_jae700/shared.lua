...
SWEP.IronSightsPos = Vector(-3.84, -3.945, 0.879)
...
SWEP.ScopeOverlayTransforms = { -10, 45 }

SWEP.VElements = {
	["rtcircle"] = { type = "Model", model = "models/rtcircle.mdl", bone = "jae_body", rel = "", pos = Vector(0.079, 0.009, 5.61), angle = Angle(0, 180, 0), size = Vector(0.411, 0.411, 0.411), color = Color(255, 255, 255, 255), surpresslightning = false, material = "!tfa_rtmaterial", skin = 0, bodygroup = {} }
}
