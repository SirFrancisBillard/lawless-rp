...
TEAM_POLICE = DarkRP.createJob("Police Officer", {
	...
	weapons = {"arrest_stick", "weapon_cuff_police", "unarrest_stick", "weapon_cs_mp5", "weapon_cs_glock", "weapon_cs_flash", "weapon_pepperspray", "stunstick", "door_ram", "weaponchecker"},
	command = "police",
	max = 12,
	salary = GAMEMODE.Config.normalsalary * 2,
	admin = 0,
...
TEAM_CHIEF = DarkRP.createJob("Police Chief", {
	...
	weapons = {"arrest_stick", "weapon_cuff_police", "unarrest_stick", "weapon_cs_m4", "weapon_cs_deagle", "weapon_cs_flash", "weapon_pepperspray", "stunstick", "door_ram", "weaponchecker"},
	command = "chief",
	max = 1,
...
TEAM_SWAT = DarkRP.createJob("SWAT", {
	...
	weapons = {"arrest_stick", "unarrest_stick", "weapon_peppershotgun", "weapon_peppergun", "weapon_cs_m249", "weapon_cs_m4", "weapon_cs_awp", "weapon_cs_deagle", "weapon_cs_usp", "weapon_cs_flash", "weapon_cs_smoke", "weapon_pepperspray", "weapon_cuff_police", "weapon_cuff_tactical", "weapon_cuff_elastic", "stunstick", "door_ram", "weaponchecker"},
	command = "swat",
	max = 4,
