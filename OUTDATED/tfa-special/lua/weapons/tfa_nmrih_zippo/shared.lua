...
SWEP.Type = "Disposable Lighter"
SWEP.PrintName = "Disposable Lighter"

SWEP.ViewModel			= "models/weapons/tfa_nmrih/v_item_zippo.mdl" --Viewmodel path
SWEP.ViewModelFOV = 50

SWEP.WorldModel			= "models/weapons/tfa_nmrih/w_item_zippo.mdl" --Viewmodel path
SWEP.HoldType = "knife"
...
SWEP.CanHold = true
SWEP.Primary.Round = "tfa_nmrih_lighter_thrown"
SWEP.Velocity = 400
