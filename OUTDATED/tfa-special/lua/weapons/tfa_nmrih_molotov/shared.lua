...
SWEP.ViewModel			= "models/weapons/tfa_nmrih/v_exp_molotov.mdl" --Viewmodel path
SWEP.ViewModelFOV = 50

SWEP.WorldModel			= "models/weapons/tfa_nmrih/w_exp_molotov.mdl" --Viewmodel path
SWEP.HoldType = "melee"
...
SWEP.Primary.Round = "tfa_nmrih_molly_thrown"